...
class OAuthBase {
	...
	function GenerateSignature($url, $consumerKey, $consumerSecret, $token, $tokenSecret, &$normalizedUrl, &$normalizedRequestParameters, $time, $nonce){
		$signatureBase = $this->GenerateSignatureBase($url, $consumerKey, $token, 'GET', $time, $nonce, 'HMAC-SHA1', $normalizedUrl, $normalizedRequestParameters);
